                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="date" class="form-control" name="fecha_nacimiento"
                                            ...
                                            placeholder="Ingrese su fecha nacimiento..." required>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="email" class="form-control" name="email" id="email"
                                            value="{{ old('email') }}" placeholder="Ingresa tu email..." required>
                                    </div>
                                    @error('email')
                                        <small style="color: red">{{ $message }}</small>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="profesion" id="profesion"
                                            value="{{ old('profesion') }}" placeholder="Ingresa tu profesion..."
                                            required>
                                    </div>
                                    @error('profesion')
                                        <small style="color: red">{{ $message }}</small>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="direccion" id="direccion"
                                            value="{{ old('direccion') }}" placeholder="Ingresa tu direccion..."
                                            required>
                                    </div>
                                    @error('direccion')
                                        <small style="color: red">{{ $message }}</small>
