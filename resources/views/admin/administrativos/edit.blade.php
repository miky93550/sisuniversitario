...
@section('content_header')
    <h1><b>Personal administrativo/Modificar personal administrativo</b></h1>
    <hr>
@stop
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select name="rol" id="" class="form-control">
                                            ...
                                            @foreach ($roles as $rol)
                                                <option
                                                    value="{{ $rol->name }}"{{ $rol->name == $administrativo->usuario->roles->pluck('name')->implode(', ') ? ' selected' : '' }}>
                                                    {{ $rol->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="apellidos" id="apellidos"
                                            value="{{ old('apellidos', $administrativo->apellido) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="ci" id="ci"
                                            value="{{ old('ci', $administrativo->ci) }}" placeholder="Ingrese ci..."
                                            required>
                                    </div>
                                    @error('ci')
                                        <small style="color: red">{{ $message }}</small>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="profesion" id="profesion"
                                            ...
                                            placeholder="Ingresa tu profesion..." required>
                                    </div>
                                    @error('profesion')
                                        <small style="color: red">{{ $message }}</small>
                                    @enderror
